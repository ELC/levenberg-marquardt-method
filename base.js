...
function plot() {
    ...
    for (var i = 0; i < iterations; i++) {
        ...
        var hessian = hessian_matrix(fun, evaluate_point, beta);
...
function hessian_matrix(fun, evaluate_point, beta) {
    return nerdamer.matrix(
...
function test_function(fun, guess_x, guess_y, beta, iterations) {
